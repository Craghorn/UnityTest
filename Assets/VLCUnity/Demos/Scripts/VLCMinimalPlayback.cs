...
public class VLCMinimalPlayback : MonoBehaviour
{
    ...
    public void PlayPause()
    {
        ...
        {
            _mediaPlayer.Pause();
            SettingsHandler.decodedAudio = _mediaPlayer.Media.Statistics.DecodedAudio;
        ...
        else
        {
            ...
            if(_mediaPlayer.Media == null)
            {
                ...
                _mediaPlayer.Media = new Media(new Uri($"{SettingsHandler.streamAddress}"));
            }
    ...
    void Update()
    {
        if (_mediaPlayer != null && _mediaPlayer.Media.Statistics.DecodedAudio > SettingsHandler.decodedAudio)
        {
            //mute music
            audioManager.GetComponent<AudioManager>().MuteBackgroundMusic();
        }
